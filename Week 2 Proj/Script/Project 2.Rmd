...
```
The source code is available at [GitHub](https://github.com/dalehurd/Developing-Data-Products-Week2-Project/blob/main/Developing-Data-Products-Week2-Project.Rproj). 
